...
<head>
<meta charset="utf-8">
<title>Sobre | Curso Lero Lero</title>
...
<body>
	<c:import url="shareContent/Header.jsp" />

    </head>
    <body class="text-center">
        <h1 >Cursos Lero Lero </h1>

         <div id="conteudo" style= "text-align: justify;"  >
            <div id="conteudo-principal" >
                <h1>Bem-vindo ao site da Lero Lero</h1>
        ...
        <div id="rodape">
            <h2>Contato <strong ></h2>
            <p id="telefone-email">
                contato@exemplo.com.br
                <br>
                <span class="ddd">21</span> 55555-5555
            </p>
            ...
            <small id="copyright">
                &copy; Lero Lero Ltda. Todos os Direitos Reservados.
            </small>
        </div>
    </div>
